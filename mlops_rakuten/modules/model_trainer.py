...
class ModelTrainer_mlflow:
    ...
    def __init__(
        ...
        #mlflow_experiment_name: str = "Rakuten_Models",
        #mlflow_run_name: str = "first_run",
        #mlflow_artifact_path: str = "SVC_rakuten",
    ...
    def run(self) -> Path:
        ...
        with mlflow_context as run:
            ...
            if cfg.enable_mlflow:
                ...
                logger.success(f"Modèle loggé dans MLflow sous '{self.mlflow_artifact_path}'")
